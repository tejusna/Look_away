...
final class StatusBarController: NSObject, NSMenuDelegate {
    ...
    private func buildMenu() -> NSMenu {
        ...
        customizeItem.view = PetCustomizeView(settings: settings)
        customizeMenu.addItem(customizeItem)
        let customizeParent = NSMenuItem(title: "Customise Pet", action: nil, keyEquivalent: "")
        customizeParent.submenu = customizeMenu
